...
parser.add_argument("-n", "--num_runs", type=int, default=20, help="specify the number of model runs")
parser.add_argument("-d", "--data", type=str, default="tmp", help="specify the number of model runs")
...
with tf.variable_scope('DMN') as scope:
    if dmn_type == "plus_preset":
        from dmn_plus_preset import DMN_PLUS
